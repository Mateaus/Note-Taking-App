package com.example.mat.roomdb_mvvm.expandablerecyclerview;
...
import com.example.mat.roomdb_mvvm.expandablerecyclerview.listeners.ExpandCollapseListener;
import com.example.mat.roomdb_mvvm.expandablerecyclerview.listeners.GroupExpandCollapseListener;
...
import com.example.mat.roomdb_mvvm.expandablerecyclerview.models.ExpandableList;
import com.example.mat.roomdb_mvvm.expandablerecyclerview.models.ExpandableListPosition;
...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
    ...
    /**
     * Notifies {@link ExpandableList} about new data changes in the list.
     * <p>
     * Should be called from any {@link Activity} or {@link Fragment} that host
     * the RecyclerView that this {@link ExpandableRecyclerViewAdapter} is attached to.
     */
    ...
    /**
     * Updates the full list of {@link ExpandableGroup} backing this RecyclerView
     *
     * @param groups the {@link ExpandableGroup} containing a list of items.
     */
